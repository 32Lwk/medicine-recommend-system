...
| 指標 | 値 |
|------|-----|
| **dispatch_success_rate_pct** | **97.59%** (933/956) |
| **shadow_regression_mismatch_rate_pct** | **2.6%** (45/1734) |
| shadow_mismatch_rate_pct | 12.0% |
| shadow_improvement_mismatch_rate_pct | 8.42% |
| shadow_exempt_rate_pct | 0.98% |
| dispatch_unhandled | 23 |
| shadow_by_mismatch_kind | agree:1526, exempt:17, gate_improvement:146, regression:45 |
...
- 計測ターン数: 2
- end-to-end: p50 2223.0ms / **p95 10757.0ms** / max 10757.0ms
- pipeline total: p50 1958.19ms / p95 10617.23ms / max 10617.23ms
- LLM 呼び出し: 合計 8 / リクエストあたり平均 4.0

| フェーズ(path) | 呼び出し | latency合計ms | p50 | p95 |
|----------------|----------|---------------|-----|-----|
| medicine_qa/focus_llm | 7 | 8191.98 | 1158.54 | 1414.32 |
| medicine_response_builder.chat_context | 1 | 2317.0 | 2317.0 | 2317.0 |
...
|------------|----------|-------|------------|--------------|------------|
| `1786051737894277934410` | exp-concierge-pivot-01 | 2 | 2/2 | 2 | Physical:1, Concierge:1 |

## 自動メトリクス（gcp-log-analysis 系）

```json
{
  "since_unix": 1786051737.8852675,
  "pipeline_baseline": {
    "exit_code": 0,
    "data": {
      "counseling_detail_path": "D:\\Programing\\medicine-recommend\\log\\counseling_detail_log.jsonl",
      "counseling_detail_total": 10211,
      "with_response": 10211,
      "response_missing": 0,
      ...
      "intent_router": {
        ...
        "shadow_mismatch": 208,
        "shadow_mismatch_rate_pct": 12.0,
        "shadow_improvement_mismatch": 146,
        "shadow_improvement_mismatch_rate_pct": 8.42,
        "shadow_regression_mismatch": 45,
        "shadow_regression_mismatch_rate_pct": 2.6,
        "shadow_exempt": 17,
        "shadow_exempt_rate_pct": 0.98,
        "shadow_by_mismatch_kind": {
          "agree": 1526,
          "gate_improvement": 146,
          "exempt": 17,
          "regression": 45
        },
        ...
        "dispatch_total": 956,
        "dispatch_handled": 933,
        "dispatch_unhandled": 23,
        "dispatch_success_rate_pct": 97.59,
        "dispatch_by_handler": {
          "concierge_agent": 369,
          "physical_agent": 438,
      ...
      "latency": {
        "pipeline_perf_requests": 2736,
        "total_ms_p50": 10175.9,
        "total_ms_p95": 39397.59,
        "total_ms_max": 227145.5,
        "llm_calls_total": 8142,
        "llm_calls_per_request_avg": 2.98,
        "llm_by_path": {
          "explanation_generator.batch_usage_notes": {
            "count": 608,
            "latency_ms_sum": 4872508.56,
            "latency_ms_p50": 8164.2,
            "latency_ms_p95": 13435.43
          },
          "medicine_qa/focus_llm": {
            "count": 2461,
            "latency_ms_sum": 2816890.93,
            "latency_ms_p50": 1049.96,
            "latency_ms_p95": 1734.93
          },
          "llm_triage.stage1": {
            "count": 1401,
            "latency_ms_sum": 2126550.38,
            "latency_ms_p50": 1390.43,
            "latency_ms_p95": 2303.86
          },
          "missing_info_service": {
            "count": 706,
            "latency_ms_sum": 1651652.42,
            "latency_ms_p50": 2206.09,
            "latency_ms_p95": 2935.54
          },
          "medicine_response_builder.chat_context": {
            "count": 220,
            "latency_ms_sum": 1349615.51,
          ...
          "chat_response_service.personalized_advice": {
            "count": 491,
            "latency_ms_sum": 801621.7,
            "latency_ms_p50": 1469.15,
            "latency_ms_p95": 2334.8
          },
          "llm_triage.stage2": {
            "count": 401,
            "latency_ms_sum": 550182.91,
...
|----|----------|------------|----------|-----------|
| exp-concierge-pivot-01 | medicine_thread_casual | `1786051737894277934410` | route_mismatch expected=Concierge got=Physical kind=medicine_qa | medicine_qa |

## 全セッション — 完全トランスクリプト

### exp-concierge-pivot-01 — medicine_thread_casual (REVIEW)
- session_id: `1786051737894277934410`
- wave: expanded
