...
- 実行時刻: 2026-06-30T17:31:14.198524+00:00
- セッション数: 1 / 総ターン: 1
- 自動合格: 1 / 要確認: 0
- GPT シミュレーション: False
...
|------------|----------|-------|------|----------------|--------------|------------|----------------|
| `1782840674223335133526` | physical-symptom-01 | 1 | PASS | 1/1 | 2 | Physical:2 | 頭痛い→OK |
...
|-------------|------------|
| physical-symptom-01 | `1782840674223335133526` |
