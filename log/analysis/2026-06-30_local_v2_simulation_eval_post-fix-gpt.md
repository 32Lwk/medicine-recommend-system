...
|------------|----------|-------|------|----------------|--------------|------------|----------------|
| `1782805521537902706377` | gpt-physical-headache | 40 | REVIEW | 59/59 | 80 | Physical:58, Counseling:20, Concierge:2 | 頭痛い→OK; ユーザー: ありがとうございます。実は、昨日から頭痛が続いていて、肩こりもありま→OK |
| `` | gpt-anxious-parent-fever | 0 | REVIEW | 0/0 | 0 | — | — |
| `` | gpt-tech-curious | 0 | REVIEW | 0/0 | 0 | — | — |
| `1782808317704216829375` | gpt-line-memory-user | 40 | REVIEW | 8/8 | 70 | Concierge:42, SessionOps:28 | 履歴って消せるの？→OK; ユーザー: 削除するって言ったら、どんな履歴が消えるの？→OK |

## 要確認 — ターン別トランスクリプト

### gpt-physical-headache (`1782805521537902706377`)
- failures: http_500
#### Turn 1
- **User**: 頭痛い
- **Bot** (`unknown`, 47822ms):
...
詳細: `2026-06-30_local_v2_intent_review_post-fix.md` §GPT

| persona | grade | 要点 |
|---------|-------|------|
| physical-headache | 🟡 | 頭痛・肩こり・カフェイン文脈は良好、終盤echo混入で劣化 |
| anxious-parent-fever | 🔴 | 接続断・データなし |
| tech-curious | 🔴 | 接続断・データなし |
| line-memory-user | 🟡 | 削除フロー到達も説明QAがループ |
