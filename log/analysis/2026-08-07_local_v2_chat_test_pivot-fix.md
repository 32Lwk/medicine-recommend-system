...
- 実行時刻: 2026-08-06T20:58:22.308297+00:00
- 所要時間: 11.2s
- シナリオ/セッション: 1 / 総ターン: 2
- 自動合格: 0 / 要確認: 1
...
| **shadow_regression_mismatch_rate_pct** | **2.55%** (43/1685) |
| shadow_mismatch_rate_pct | 12.05% |
| shadow_improvement_mismatch_rate_pct | 8.49% |
| shadow_exempt_rate_pct | 1.01% |
| dispatch_unhandled | 23 |
| shadow_by_mismatch_kind | agree:1482, exempt:17, gate_improvement:143, regression:43 |
...
- 計測ターン数: 2
- end-to-end: p50 1765.0ms / **p95 8937.0ms** / max 8937.0ms
- pipeline total: p50 1615.12ms / p95 8674.46ms / max 8674.46ms
- LLM 呼び出し: 合計 7 / リクエストあたり平均 3.5

| フェーズ(path) | 呼び出し | latency合計ms | p50 | p95 |
|----------------|----------|---------------|-----|-----|
| medicine_qa/focus_llm | 6 | 7071.31 | 1016.54 | 1895.03 |
| medicine_response_builder.chat_context | 1 | 1504.53 | 1504.53 | 1504.53 |
...
|------------|----------|-------|------------|--------------|------------|
| `1786049902316939109540` | exp-concierge-pivot-01 | 2 | 2/2 | 2 | Physical:1, Concierge:1 |

## 自動メトリクス（gcp-log-analysis 系）

```json
{
  "since_unix": 1786049902.3082972,
  "pipeline_baseline": {
    "exit_code": 0,
    "data": {
      "counseling_detail_path": "D:\\Programing\\medicine-recommend\\log\\counseling_detail_log.jsonl",
      "counseling_detail_total": 10163,
      "with_response": 10163,
      "response_missing": 0,
      ...
      "intent_router": {
        ...
        "shadow_mismatch": 203,
        "shadow_mismatch_rate_pct": 12.05,
        "shadow_improvement_mismatch": 143,
        "shadow_improvement_mismatch_rate_pct": 8.49,
      ...
      "latency": {
        ...
        "llm_by_path": {
          ...
          "medicine_qa/focus_llm": {
            "count": 2359,
            "latency_ms_sum": 2697501.31,
            "latency_ms_p50": 1047.48,
            "latency_ms_p95": 1734.93
          },
          "llm_triage.stage1": {
            "count": 1365,
            "latency_ms_sum": 2076292.88,
...
|----|----------|------------|----------|-----------|
| exp-concierge-pivot-01 | medicine_thread_casual | `1786049902316939109540` | route_mismatch expected=Concierge got=Physical kind=medicine_qa | medicine_qa |

## 全セッション — 完全トランスクリプト

### exp-concierge-pivot-01 — medicine_thread_casual (REVIEW)
- session_id: `1786049902316939109540`
- wave: expanded
- 医薬品→メタ質問への話題転換（新トピック）
#### Turn 1
- **User**: ロキソニンの副作用教えて
- **Bot** (`medicine_side_effect_qa`, 1765ms):

「ロキソニンS」の主な副作用の要点です（添付文書ベース）。ショック、アナフィラキシー、溶血性貧血、急性汎発性発疹性膿疱症、便秘 などが報告されています。個人差があります。気になる症状が出た場合は使用を中止し、薬剤師・医師に相談してください。

#### Turn 2
- **User**: 技術スタックは？
- **Bot** (`medicine_qa`, 8937ms):
