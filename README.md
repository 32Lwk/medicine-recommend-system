...
**最終更新日: 2025年12月28日（構造化ログシステムの実装）**
...
### 13. ログと監査（2025年12月28日大幅改善）

#### 13.1 構造化ログシステム（2025年12月28日追加）
...
2. **カウンセリング詳細ログ** (`log_counseling_detail`)（2025年12月28日改善）
   - ユーザー入力全文
   - システムの返信全文
   - 会話履歴（最新10件）
...
5. **エラー詳細ログ** (`log_error_detail`)（2025年12月28日改善）
   - エラーメッセージ
   - スタックトレース全文
