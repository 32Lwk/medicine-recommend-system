...
- **主要解熱鎮痛薬のスコアリング改善（2026年1月3日追加）**:
  - **主要解熱鎮痛薬の定義**: カロナールA、ロキソニンS、タイレノールAなどの第一選択として推奨される解熱鎮痛薬
