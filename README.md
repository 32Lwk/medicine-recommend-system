...
**最終更新日: 2025年12月29日（店舗案内機能の拡張・商品検出機能の改善・緊急事案検出機能の実装・キーワードリストの大幅拡充）**
...
- **事前トリアージ（振り分け）**: ユーザー入力を5つのカテゴリに自動分類
  - **Physical（身体的症状）**: 頭痛、発熱、のどの痛みなど → 従来の薬推奨フローへ
  - **Emotional（精神的・感情的症状）**: 緊張、不安、恋愛の悩みなど → カウンセリングフローへ
...
- **期間・妊娠/授乳チェック機能（2025年12月25日追加）**: 不眠カウンセリング中に、以下の条件を満たす場合はカウンセリングを中止して受診勧告
