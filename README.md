...
- **症状特異性ペナルティ**: 単一症状時に複合薬（総合感冒薬など）にペナルティを適用し、特化薬を優先
  - **単一症状時の推奨ロジック（2026年1月2日詳細化）**: 各症状に対して最適な医薬品タイプを推奨
    - **発熱**: 解熱鎮痛薬を優先（総合風邪薬には-0.3のペナルティ）
    - **のどの痛み**: 外用薬（のど）を最優先（+0.15）、次に解熱鎮痛薬（総合風邪薬には-0.15のペナルティ）
    - **咳**: 鎮咳薬を優先（総合風邪薬には-0.2のペナルティ）
    - **頭痛**: 解熱鎮痛薬を優先（総合風邪薬には-0.2のペナルティ）
...
- **総合感冒薬推奨ロジックの強化（2025年12月31日追加・2026年1月2日大幅改善）**: 複数症状時に総合感冒薬を優先的に推奨
  - **複数症状時のボーナス強化（2026年1月2日改善）**: 2症状以上の場合、総合感冒薬に+0.9のボーナスを付与（従来の+0.55から大幅強化）
  - **1症状時の軽度ボーナス（2026年1月2日追加）**: 1症状の場合でも+0.4のボーナスを付与
...
### ルールベーススコアリング（2025年11月1日更新・2025年12月31日修正・2026年1月2日改善・単一症状スコアリング改善）
