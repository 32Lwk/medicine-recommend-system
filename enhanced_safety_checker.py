...
ENHANCED_SCORING_WEIGHTS = {
    ...
    "効能特異性": 0.20,      # 維持
    "副作用リスク": -0.10,   # -0.12から-0.10に調整（負の値の影響を適度に保つ）
    "年齢適合性": 0.12,      # 維持
    "用法簡便性": 0.03,      # 維持
    "相互作用リスク": -0.05, # -0.06から-0.05に調整
    "禁忌チェック": -1.0,    # 維持（禁忌薬は完全除外）
    "安全性スコア": 0.08     # 0.10から0.08に調整
    # 正の値の合計: 0.30 + 0.20 + 0.12 + 0.03 + 0.08 = 0.73
    # 基本スコアの範囲: 約0.6-0.73（副作用/相互作用リスクが0の場合、実際は0.58-0.73程度）
    # ボーナス/ペナルティの余地: 約0.25（最大0.98程度まで）
