...
_ABOUT: dict[str, dict[str, dict[str, Any]]] = {
    "index": {
        "ja": {
            ...
            "hero_subtitle": "ルールベース推奨 × LLM のハイブリッド。症状・体調・生活背景から OTC 候補と注意点を整理します。医療・薬学の専門家向け β として、実際のチャット UI で挙動を検証できます。診断・処方の代替ではありません。",
            "hero_highlights": [
                "チャットで症状を入力 — 専門知識がなくても相談を開始できます",
                "ルールベースで候補を整理 — 推奨根拠・成分重複・受診目安を表示",
                "4言語対応 — 日本語・英語・中国語・韓国語（DeepL 翻訳）",
            ],
            "beta_badge": "🔬 研究β版｜専門家向け・非診断",
            "scroll_hint": "スクロール",
            "hero_image": "img/about/generated/about/hero/hero-pharmacy-chat.png",
            "hero_alt": "チャット型医薬品相談ツール（β版）の紹介バナー",
            "hero_cta": "チャットを試す",
            "problem_section_num": "01",
            "problem_section_tag": "課題",
            "problem_heading": "現場の3つの壁",
            "problem_lead": "少子高齢化・訪日外国人・EC の拡大のなか、薬局と利用者の双方に負荷が偏っています。相談機会の不足は、誤選択や不安の長期化につながりかねません。",
            "how_section_num": "02",
            "how_section_tag": "使い方",
            ...
            "problem_cards": [
                {
                    "emoji": "🌐",
                    "title": "言語の壁",
                    "body": "訪日外国人など、母語で相談しづらく、適切な市販薬選びが難しい場面があります。多言語 UI と翻訳で、初動の self-care 判断を支援します。",
                },
                {
                    "emoji": "🏥",
                    "title": "人手不足",
                    "body": "薬局・ドラッグストアでは、相談時間の確保が難しく、利用者の不安が残ることがあります。混雑時でもチャットで一次情報を整理できます。",
                },
                {
                    "emoji": "💊",
                    "title": "選びにくさ",
                    "body": "症状に合う市販薬がわからず、安全性への不安が生じる利用者がいます。候補・注意点・成分重複を一画面で確認できます。",
                },
            ],
            ...
            "how_demo_image": "img/about/generated/about/demo/demo-phone-01-greeting.png",
            "how_demo_shots": [
                {
                    "src": "img/about/generated/about/demo/demo-phone-01-greeting.png",
                    "alt": "症状入力前のチャット画面（β版）",
                },
                {
                    "src": "img/about/generated/about/demo/demo-phone-02-analyzing.png",
                    "alt": "AI 分析中の進捗表示（β版）",
                },
                {
                    "src": "img/about/generated/about/demo/demo-phone-03-recommendation.png",
                    "alt": "推奨医薬品カードと適合度スコア（β版）",
                },
                {
                    "src": "img/about/generated/about/demo/demo-phone-04-comparison.png",
                    "alt": "医薬品比較の回答表示（β版）",
                },
            ],
            "how_demo_alt": "Sage Terrace 調チャット UI（β版）の実機スクリーンショット",
            "how_demo_caption": "本番 Sage Terrace UI（β版）の実画面。症状入力 → AI 分析 → 推奨・比較までの流れです。",
        ...
        "en": {
            ...
            "hero_subtitle": "Rule-based scoring × LLM assist. Organizes OTC options and cautions from symptoms and context. This beta lets specialists evaluate live chat behavior—not a substitute for diagnosis or prescribing.",
            "hero_highlights": [
                "Chat-first intake — describe symptoms in plain language",
                "Rule-based ranking — rationale, overlap warnings, and care guidance",
                "Four languages — Japanese, English, Chinese, Korean (DeepL)",
            ],
            "beta_badge": "🔬 Research beta · specialists · non-diagnostic",
            "scroll_hint": "SCROLL",
            "hero_image": "img/about/generated/about/hero/hero-pharmacy-chat.png",
            "hero_alt": "Promotional banner for the chat OTC consultation tool (beta)",
            "hero_cta": "Try the chat",
            "problem_section_num": "01",
            "problem_section_tag": "Challenges",
            "problem_heading": "Three pressures on the ground",
            "problem_lead": "Aging populations, language barriers, and e-commerce are shifting demand—and strain—on pharmacies and shoppers alike. Gaps in counseling time can prolong uncertainty and unsafe choices.",
            "how_section_num": "02",
            ...
            "how_demo_shots": [
                {
                    "src": "img/about/generated/about/demo/demo-phone-01-greeting.png",
                    "alt": "Chat screen before entering symptoms (beta)",
                },
                {
                    "src": "img/about/generated/about/demo/demo-phone-02-analyzing.png",
                    "alt": "AI analysis progress (beta)",
                },
                {
                    "src": "img/about/generated/about/demo/demo-phone-03-recommendation.png",
                    "alt": "Recommended product card with match score (beta)",
                },
                {
                    "src": "img/about/generated/about/demo/demo-phone-04-comparison.png",
                    "alt": "Medicine comparison response (beta)",
                },
            ],
            "how_demo_alt": "Production Sage Terrace chat UI screenshots (beta)",
            "how_demo_caption": "Live Sage Terrace UI (beta): symptom input → AI analysis → recommendations and comparison.",
        ...
        "ko": {
            ...
            "hero_subtitle": "규칙 기반 추천 × LLM 하이브리드. 증상·생활 정보에서 OTC 후보와 주의점을 정리합니다. 의료·약학 전문가용 β로 실제 채팅 UI에서 동작을 검증할 수 있습니다. 진단·처방 대체가 아닙니다.",
            "hero_highlights": [
                "채팅으로 증상 입력 — 전문 지식 없이 상담 시작",
                "규칙 기반 후보 정리 — 근거·성분 중복·진료 권고 표시",
                "4개 언어 — 일본어·영어·중국어·한국어(DeepL)",
            ],
            "beta_badge": "🔬 연구 β판｜전문가·비진단",
            "scroll_hint": "스크롤",
            "hero_image": "img/about/generated/about/hero/hero-pharmacy-chat.png",
            "hero_alt": "채팅형 OTC 상담 도구(β) 소개 배너",
            "hero_cta": "채팅 체험",
            "problem_section_num": "01",
            "problem_section_tag": "과제",
            "problem_heading": "현장의 세 가지 벽",
            "problem_lead": "고령화·방문 외국인·EC 확대 속에서 약국과 이용자 모두에 부담이 쏠리고 있습니다. 상담 기회 부족은 오선택과 불안 장기화로 이어질 수 있습니다.",
            "how_section_num": "02",
            "how_section_tag": "사용법",
            "features_section_num": "03",
            ...
            "how_demo_alt": "Sage Terrace 채팅 UI(β) 실기 스크린샷",
            "how_demo_caption": "본番 Sage Terrace UI(β) 실화면. 증상 입력 → AI 분석 → 추천·비교 흐름입니다.",
        ...
        "zh": {
            ...
            "hero_subtitle": "规则推荐 × LLM 混合方式。根据症状与生活背景整理 OTC 候选与注意事项。面向医疗与药学专家的 β 版，可在实际聊天 UI 中验证行为。非诊断或处方替代。",
            "hero_highlights": [
                "聊天输入症状 — 无需专业知识即可开始",
                "规则引擎整理候选 — 显示依据、成分重复与就诊建议",
                "四种语言 — 日英中韩（DeepL 翻译）",
            ],
            "beta_badge": "🔬 研究测试版｜专业人士·非诊断",
            "scroll_hint": "向下滚动",
            "hero_image": "img/about/generated/about/hero/hero-pharmacy-chat.png",
            "hero_alt": "聊天式 OTC 咨询工具（测试版）介绍横幅",
            "hero_cta": "体验聊天",
            "problem_section_num": "01",
            "problem_section_tag": "课题",
            "problem_heading": "现场的三大压力",
            "problem_lead": "在老龄化、访日外国人与电商普及的背景下，药店与使用者双方都承受更大压力。咨询时间不足可能加剧误选与长期不安。",
            "how_section_num": "02",
            "how_section_tag": "用法",
            "features_section_num": "03",
            ...
            "how_demo_alt": "Sage Terrace 聊天 UI（测试版）实机截图",
            "how_demo_caption": "生产环境 Sage Terrace UI（测试版）实画面：症状输入 → AI 分析 → 推荐与比较。",
