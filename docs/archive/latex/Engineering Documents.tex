...
\item \textbf{チャット通知}: 開発者への通知（すべてのアラート）
...
\item \textbf{相互作用データ}: PMDAの医薬品相互作用データベース
  ...
  \end{itemize}
\item \textbf{漢方薬データ}: 開発者（登録販売者）による手動構築
  \begin{itemize}
...
\item \textbf{品質管理}: 
  \begin{itemize}
  \item 開発者（登録販売者）による定期的なレビュー（四半期に1回）
  \item 誤検出パターンの分析と修正
  \item 症状の重み付けの最適化
  \end{itemize}
\end{enumerate}
...
\begin{itemize}
\item \textbf{翻訳精度}: 開発者（登録販売者）によるレビュー（サンプル100件、精度95\%以上）
