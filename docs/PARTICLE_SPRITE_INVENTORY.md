...
`PARTICLE_PROFILES` の `sprites` と `static/img/particles/` の対応。生成は **Cursor 画像生成**（透明背景をプロンプトで指定）。フォールバック暦月キーは絵文字のみ。

| プロファイル鍵 | スプライト（`img/particles/...`） |
|----------------|-----------------------------------|
| valentine | `valentine/heart-glow.png` |
...
| graduation | `graduation/cap-soft.png` |
| enrollment | `enrollment/bag-soft.png` |
| hanami | `hanami/petal-soft.png` |
| gw | `gw/car-soft.png`, `gw/plane-soft.png` |
| kodomonomi | `kodomonomi/carp-streamer-soft.png`, `kodomonomi/kabuto-soft.png` |
