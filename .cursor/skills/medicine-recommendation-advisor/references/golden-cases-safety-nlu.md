...
### GC-SAFE-DX-005b: 不眠症+睡眠薬探索（成人）

- **入力**: `不眠症です。市販の睡眠薬を探しています`
- **ターゲット**: **カウンセリング後 → OTC 可**（[オーケストレーター基準](diagnosis-counseling-orchestrator.md)）
- **小児**: **OTC 不可**（年齢ゲート）
- **根拠**: GC-DX-MH-010
...
- **入力**: `最近眠れません`
- **ターゲット**: **カウンセリングフロー経由** → ゲート充足後 Physical / OTC 可（通常フロー直行しない）
- **根拠**: オーナー Q4；[diagnosis-counseling-orchestrator.md](diagnosis-counseling-orchestrator.md)

### GC-SAFE-DX-008: 慢性腎臓病+頭痛

- **入力**: `慢性腎臓病ですが、頭痛がします`
- **ターゲット**: **カウンセリング優先・OTC 原則なし**（腎機能・相互作用）
- **同様**: 心不全+頭痛も不可（高リスク chronic）
- **根拠**: オーナー Q2
